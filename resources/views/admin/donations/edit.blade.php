...
@section('content')
 ...
 <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
               <form action='{{route('admin.donation.update', encrypt($donation->id))}}' method='post' enctype='multipart/form-data'>
              @csrf
              <div class="card">
                        <div class="card-body">
                            <h6 class="card-title">Edit Donation Categories </h6>
                          
                            <div class="row">
                                     <div class="col-md-6">
                                       <div class="form-group">
                                      <input type="text" name="title" placeholder="Enter Title" value="{{$donation->title}}" class="form-control @error('title') is-invalid @enderror" >
                                         ...
                                         <div class="col-md-6">
                                          <div class="form-group">
                                         <input type="text" name="goal_amount" placeholder="Enter Target Amount" value="{{$donation->goal_amount}}" class="form-control @error('goal_amount') is-invalid @enderror" readonly>
                                         ...
                                         <div class="col-md-12">
                                           ...
                                           <textarea id="summernote" name="content"  class="form-control @error('content') is-invalid @enderror" >
                                            {{$donation->content}}
                                              ...
                                              <div class="col-md-12">
                                                <div class="form-group">
                                                  <img src="{{asset('images/'.$donation->image)}}" width="50px">
