...
@section('content')
 <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form action='{{route('admin.BlogsUpdate',encrypt($blog->id))}}' method='post', enctype='multipart/form-data'>
                @csrf
              <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <textarea id="summernote" class="@error('contents') is-invalid @enderror" name="contents">{{$blog->contents}}</textarea>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-4">
                        <div class="p-5">
                             <button type="submit" class="btn btn-primary p-3">Update Blog</button>
                           </div>
                           </div>
                           </div>
                        </div>
