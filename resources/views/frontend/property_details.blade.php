...
@section('contents')
<div class="page-header parallaxie" style="background-image:url({{asset('images/'.$property?->image)}})">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="page-header-box">
                    <h2 class="text-anime" style="color:#fff">{{$property->title}}</h2>
                    <nav class="wow fadeInUp" data-wow-delay="0.25s">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('index')}}">Home</a></li>
                            <li class="breadcrumb-item active" aria-current="page">/ Property for Sale details</li>
                        </ol>
                    </nav>
                </div>
            </div>
			...
			<div class="row">
				<div class="col-lg-8">
					...
					<div class="property-single-content">
 					...
 					<h2 class="text-anime" style="color:#0c0c0c">{{$property->title}}</h2>
